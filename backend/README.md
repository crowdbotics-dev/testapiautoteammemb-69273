...
## Project Structure
    ...
    ├── testapiautoteammemb_69273  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_69273`
...
2. Clone this repo and `cd testapiautoteammemb_69273`
